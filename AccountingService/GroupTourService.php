...
<html>
	...
	<body>
								...
								<div class="accountingLeft">
									...
									<div class="filerCondition">
										...
										<ul class="filerDetail ">
											...
											<li>
												<label>客户机构</label>
												<input type="text" id="accounting-service-filter-agency">
											</li>
											<li>
												<label>销售人员</label>
									...
									<div class="modifyOrders filerCondition">
										<ul class="filerDetail">
											...
											<li>
												<label>利润</label>
												<input type="text" placeholder="" id="orderProfit" disabled>
											</li>
											<li class="actionFilerBox">
		...
		<script src="../js/homePage/accountingService.js"></script>
