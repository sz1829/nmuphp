...
<html>
	...
	<body>
						...
						<div class="floor accountingInfo">
							<div class="navGroup accountingNav">
								<ul>
									...
									<li class="groupTour accountingNav-active">
										<a href="javascript:void(0);">
											独立团
										</a>
									</li>
							...
							<div class="groupMsg historicRecord">
								...
								<div class="filterGroupTourInfo filterInfo">
									<label class="markMsg"><i></i>独立团信息</label>
									<ul>
										<li class="infoDistrict">
											<label>总人数</label>
										...
										<li>
											<label>巴士公司</label>
											<input type="text" id="bus-company">
										</li>
										<li>
											<label>代理商</label>
										...
										<li>
											<label>导游姓名</label>
											<input id="tourist-guide" type="text" placeholder="Search...">
										</li>
										<li class="infoDistrict">
											<label>行程日期</label>
								...
								<div class="groupTourInfo filterInfo tabCard">
									...
									<ul>
										<li>
											<div class="checkbox checkbox-success">
												<input id="group_code" class="styled" type="checkbox">
										...
										<li>
											<div class="checkbox checkbox-success">
												<input id="flight_number" class="styled" type="checkbox">
										...
										<li>
											<div class="checkbox checkbox-success">
												<input id="bus_company" class="styled" type="checkbox">
												<label for="bus_company">
					                           		巴士公司
					                           		<i></i>
					             				</label>
					             			</div>
										...
										<li>
											<div class="checkbox checkbox-success">
												<input id="guide_name" class="styled" type="checkbox">
										...
										<li>
											<div class="checkbox checkbox-success">
												<input id="guide_phone" class="styled" type="checkbox">
												<label for="guide_phone">
					                           		导游电话
					                           		<i></i>
					             				</label>
					             			</div>
										...
										<li>
											<div class="checkbox checkbox-success">
												<input id="agency_name" class="styled" type="checkbox">
								...
								<div class="resultInfo">
									...
									<div class="nav-box eg">
										<ul class="pagination m-style" id="groupTourOrders"></ul>
									</div>
								</div>
							</div>
						</div>
		...
		<script src="../js/OrderHistory/groupOrders.js" type="text/javascript"></script>
	</body>
</html>
